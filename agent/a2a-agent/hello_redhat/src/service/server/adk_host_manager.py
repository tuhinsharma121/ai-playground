...
from hello_redhat.src.hosts.multiagent.host_agent import HostAgent
from hello_redhat.src.hosts.multiagent.remote_agent_connection import (
    TaskCallbackArg,
)
from hello_redhat.src.service.server.application_manager import ApplicationManager
from hello_redhat.src.service.types import Conversation, Event
from hello_redhat.src.utils.agent_card import get_agent_card
...
class ADKHostManager(ApplicationManager):
    ...
    def adk_content_to_message(
        ...
        parts: list[Part] = []
        if content is not None and not content.parts:
            return Message(
                parts=[],
