...
from hello_redhat.src.common.client import A2ACardResolver, A2AClient
from hello_redhat.src.common.types import TaskState
from hello_redhat.src.common.utils.push_notification_auth import PushNotificationReceiverAuth
...
async def cli(
    ...
    if use_push_notifications:
        from hello_redhat.src.hosts.cli.push_notification_listener import (
